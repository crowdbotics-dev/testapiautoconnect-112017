...
## Project Structure
    ...
    ├── testapiautoconnect_112017  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112017`
...
2. Clone this repo and `cd testapiautoconnect_112017`
